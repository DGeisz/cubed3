...
export async function updateCanvasEverywhere(
    ...
    return createTransactionNotification(
        ...
        {
            pending: created
                ? "Adding cube to canvas..."
                : "Removing cube from canvas...",
            success: created
                ? "Successfully added cube!"
                : "Successfully removed cube!",
        }
    );
}
...
export async function getMoreCubes(
    ...
    return await createTransactionNotification(
        async () => {
            ...
            const { canvas_time, canvas_pda, canvas_bump } =
                await getCanvasInfo(canvasTime, program.programId);

            const { master_pda, master_bump } = await getDefaultAddresses(
                program
            );
        ...
        {
            pending: "Purchasing cubes...",
            success: `Successfully purchased ${numberWithCommas(
                numCubes
            )} cubes!`,
        }
    );
...
export async function finishMosaic(
    ...
    return await createTransactionNotification(
        ...
        {
            pending: "Finishing mosaic...",
            success: "Successfully finished mosaic!",
        }
    );
}
...
export async function listMosaic(
    ...
    return await createTransactionNotification(
        async () => {
            const { master_bump, master_pda } = await getDefaultAddresses(
                program
            );

            const { escrow_pda, escrow_bump } =
                await getListingEscrowAccountInfo(
                    canvasTime,
                    program.programId
                );
        ...
        {
            pending: "Listing mosaic...",
            success: "Successfully listed mosaic!",
        }
    );
}
...
export async function changeListing(
    ...
    return await createTransactionNotification(
        ...
        {
            pending: "Changing listing...",
            success: "Successfully changed listing!",
        }
    );
}
...
export async function removeListing(
    ...
    return await createTransactionNotification(
        ...
        {
            pending: "Removing listing...",
            success: "Successfully removed listing!",
        }
    );
}
...
export async function buyMosaic(
    ...
    return await createTransactionNotification(
        ...
        {
            pending: "Purchasing mosaic...",
            success: "Successfully purchased mosaic!",
        }
    );
}
